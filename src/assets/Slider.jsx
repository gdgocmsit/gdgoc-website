    ...
    <div className="w-full overflow-hidden">
      ...
      <div className="relative py-14 px-3 sm:px-6 lg:px-8">
        <div className="relative">
          <h1 className="text-center font-heading text-6xl sm:text-8xl lg:text-[10rem] xl:text-[16rem] leading-none mb-4">
        ...
        <div className="mt-28 sm:mt-20 lg:mt-72 text-center w-full px-4 sm:px-8 lg:px-16">
      ...
      {/* Our Team Section */}
      <div className="py-10">
        <h2 className="text-5xl sm:text-6xl lg:text-8xl xl:text-9xl mb-6 text-center font-heading text-black">
          OUR TEAM
        </h2>
            ...
            >
              <div className="flex">
                {slideGroups.map(([department, members], index) => (
                  ...
                  >
                    <h2 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl text-center font-heading mb-4 mt-6 sm:mt-9">
                      {department}
                    </h2>
